...
const positions = [
    "Básica", // Posición de portero
    "Suite", // Posición de defensa central
    "Ejecutiva", // Posición de lateral derecho
    "Suite Presidencial", // Posición de lateral izquierdo
    "Habitacíon Cama King", // Posición de mediocampista defensivo
    "Habitación cama Queen", // Posición de mediocampista ofensivo
    "Deluxe", // Posición de extremo derecho
];
